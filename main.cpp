...
int main() {
	...
	while (getline(domesticFile, line)) {
		...
		getline(ss, s_researchScore, ',');    researchScore = atoi(s_researchScore.c_str());
	...
	//		<< cgpa << ", research score of " << researchScore << "and TOEFL 
	//		Score of "<< toeflScore<< endl; //Must calculate the toeflscore
